...
contract('QuantorToken', function(accounts) {
  it("should put 2000000000 QNT to supply and in the first account", async function () {
    const instance = await QuantorToken.new();
  ...
  it("should not allow to release by not release agent", async () => {
    let token = await QuantorToken.new();
